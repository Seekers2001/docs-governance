...
description: "盘点并维护项目测试资产，把需求、业务规则、风险和 Bug 转成 TEST-ID 与可验证证据，生成或更新 TESTS.md。用于测试资产盘点、测试缺口分析、单元/集成/契约/E2E/冒烟分类、Bug 回归保护、测试必要性判断、测试清单维护与交付前测试证据审查。中文触发：测试盘点、测试清单、测试资产、测试缺口、测试必要性、Bug 转测试、测试治理。English triggers: test inventory, test catalog, test gap analysis, bug-to-test, test governance."
---
